...
pub mod zhtp_uuids {
    /// ZHTP Mesh Service UUID
    pub const ZHTP_MESH_SERVICE: &str = "6ba7b810-9dad-11d1-80b4-00c04fd430c8";
    
    /// ZK Authentication characteristic
    pub const ZK_AUTH_CHAR: &str = "6ba7b811-9dad-11d1-80b4-00c04fd430c8";
    
    /// Quantum-resistant routing characteristic
    pub const QUANTUM_ROUTING_CHAR: &str = "6ba7b812-9dad-11d1-80b4-00c04fd430c8";
    
    /// Mesh data transfer characteristic
    pub const MESH_DATA_CHAR: &str = "6ba7b813-9dad-11d1-80b4-00c04fd430c8";
    
    /// Mesh coordination characteristic
    pub const MESH_COORD_CHAR: &str = "6ba7b814-9dad-11d1-80b4-00c04fd430c8";
}
